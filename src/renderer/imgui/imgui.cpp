...
#	define STBTT_fabs(_a)     fabs(_a)
#	define STBTT_strlen(_str) strlen(_str)
...
#	include <bgfx/bgfx/3rdparty/stb/stb_rect_pack.h>
#	define STB_TRUETYPE_IMPLEMENTATION
#	include <bgfx/bgfx/3rdparty/stb/stb_truetype.h>
#endif // USE_LOCAL_STB
